        ...
        <Grid stackable centered>
          ...
          {consults.length > 0 ?
            <Grid.Column width={16} className="landing-consults-part" style={{backgroundColor: landing_consults_background_color}}>
              <Header as="h3" style={{margin: "2em 0"}}>Les consultations du moment</Header>
...
export default LandingPageContainer = createContainer(() => {
  const starConsultsPublication = Meteor.subscribe('consults.landing')
  const loading = !starConsultsPublication.ready()
